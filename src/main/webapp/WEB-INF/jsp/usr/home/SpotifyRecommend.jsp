...
<c:if test="${maxGenre == 'Classic'}">
		...
		<img class="image"  src="https://cdn.imweb.me/thumbnail/20220831/601b733c0051b.jpg" width="500" alt="" />
	</c:if>
...
<c:if test="${maxGenre == 'Grunge'}">
		<div>선택한 아티스트의 장르는 ${artistGenre } 입니다. 어울리는 스타일은~! : ${maxGenre } 입니다. 이런 스타일 어때요?</div>
		<img class="image"  src=https://www.topstarnews.net/news/photo/201905/620746_311554_4140.jpg width="500" alt="" />
	</c:if>
